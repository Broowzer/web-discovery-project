...
export class ContentExtractor {
  ...
  tryExtractBroowzerSerpQuery(url) {
    const isBroowzerSearch =
      url.startsWith("https://search.broowzer.com/search?") ||
      url.startsWith("https://broowzersearch.com/search?") ||
      url.startsWith("https://search.broowzer.software/search?");
    return isBroowzerSearch && parse(url).searchParams.get("q");
  }
}
