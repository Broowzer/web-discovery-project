...
const queryStrings = [
  ...
  {
    url: "http://pix04.revsci.net/F09828/b3/Z/3/120814/588347998.js?D=DM_LOC%3Dhttp%253A%252F%252Fwww.eltern.de%252F%253Fbpid%253Dgrunerjahr%2526_rsiL%253D0%26DM_EOM%3D1&C=F09828&asidi=broowzer.com/tracking&asidi=V6roVyy38IZUh0ZkC_jXhw",
    url_parts: {
      protocol: "http",
      hostname: "pix04.revsci.net",
      path: "/F09828/b3/Z/3/120814/588347998.js",
      query:
        "D=DM_LOC%3Dhttp%253A%252F%252Fwww.eltern.de%252F%253Fbpid%253Dgrunerjahr%2526_rsiL%253D0%26DM_EOM%3D1&C=F09828&asidi=broowzer.com/tracking&asidi=V6roVyy38IZUh0ZkC_jXhw",
      searchParams: [
        [
          "D",
  ...
  () => {
    describe("#compare", function () {
      ...
      it("with exactly same urls returns true", function () {
        chai.expect(equals("https://broowzer.com", "https://broowzer.com")).to.be
          .true;
      });

      it("with missing urls returns false", function () {
        chai.expect(equals("https://broowzer.com", "")).to.be.false;
        chai.expect(equals("", "https://broowzer.com")).to.be.false;
    ...
    describe("#parse", () => {
      ...
      describe("get", function () {
        ...
        it("returns parsed url info for valid url", () => {
          const urlParts = parse("https://broowzer.com");
          chai.expect(urlParts.hostname).to.equal("broowzer.com");
    ...
    describe("#equals", () => {
      ...
      [
        ["http://broowzer.com", "http://broowzer.com"],
        ["http://broowzer.com", "http://broowzer.com/"],
        ["http://broowzer.com:80", "http://broowzer.com"],
        ["https://broowzer.com", "https://broowzer.com:443"],
        [
          "https://broowzer.com/test?q=hi#anchor",
          "https://broowzer.com:443/test?q=hi#anchor",
        ],
        ["https://user:pass@broowzer.com/", "https://user:pass@broowzer.com"],
        ["http://xn--mnchen-3ya.de/", "http://münchen.de"],
        ["http://broowzer.com/test%20site/", "http://broowzer.com/test site/"],
      ].forEach((urls) => {
      ...
      [
        [null, null],
        ["", ""],
        ["http://broowzer.com:443", "https://broowzer.com"],
        ["https://user:pass@broowzer.com/", "https://user:pas@broowzer.com/"],
        ["https://user:pass@broowzer.com/", "https://user:pas@broowzer.com/"],
        ["http://www.broowzer.com/", "http://www3.broowzer.com/"],
      ].forEach((urls) => {
        const [url1, url2] = urls;
